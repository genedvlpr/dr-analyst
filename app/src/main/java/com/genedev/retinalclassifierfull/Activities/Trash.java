...
public class Trash extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new ListingAdapter(Trash.this,patients);
    ...
    public void getDataFromServer()
    {
        ...
        databaseReference.child("users").child(userId).child("trash").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            mProgressDialog = new ProgressDialog(Trash.this);
    ...
    private class ListingAdapter extends BaseAdapter {
        ...
        {
            Intent i=new Intent(context,PatientDeletedDetailedView.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            Intent back = new Intent(Trash.this,Home.class);
            startActivity(back);
            Trash.this.finish();
        }
    ...
    private void alertDialog(){
        ...
        text.setText("You can manage here all your deleted patient details for you to recover it again.");
